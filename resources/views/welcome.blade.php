...
<html lang="en" class="scroll-smooth">
  ...
  <body>
    <session id="content">
      <header style="background: url({{ asset('assets/images/2.jpg') }}); background-size: cover;">
          <div class="logo">
            <img src="assets/images/Logo_Dai_hoc_Can_Tho.svg.png" alt="" sizes="" srcset="" width="100px" height="100px">
          </div>

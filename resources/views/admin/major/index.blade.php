...
<table id="major-table" class="table table-hover">
    <thead>
        <tr>
            <th>STT</th>
            <th>Tên khoa</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-right">
                <form action="{{route('major.destroy', $model->id)}}" method="post" >
                    @csrf @method('DELETE')
                    <a href="{{ route('major.edit', $model->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
